...
<head>
    ...
    <title>Test | Bateria para Conductores | Norma035</title>
    <style>
        input[type="number"],
        input[type="text"] {
            display: block;
                            ...
                            <div class="tarjeta-opciones">
                                ...
                                <div class="card back-face">
                                    <div class="info">
                                        ...
                                        <p class="card-text">
                                            Si deseas un asesoramiento con nuestro personal de psicología, haz click
                                ...
                                <table class="table table-bordered table-fill" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    if (empty($citas)) {
                                        ...
                                        foreach ($citas as $clave => $citasDisp) {
                                            ...
                                            echo "<td align='center'><a href='agendar_cita_psicologia.php?id_cita=$clave&id_persona=$id_persona'>
    ...
    <div class="modal fade" id="modalGuia" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="
                ...
                color: black;">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Guía Rápida</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
