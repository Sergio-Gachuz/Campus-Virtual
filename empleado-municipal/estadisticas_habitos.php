...
<head>
    ...
    <script src="../js/Datos HabitosA.js"></script>
    ...
    <div class="container" id="perfil">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h2><img src="../img/Iconos/dashboard.png" alt="historico" width="50"> DASHBOARD | HÁBITOS ALIMENTICIOS</h2>
                        <div class="row">
                            <canvas id="habitos"></canvas>
                        </div>
                    </div>
                </div>
                <br>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered "width="100%" cellspacing="0">
                                <?php
                                $personal = $trabajador->personas_sin_realizar_habitos($_SESSION['id_direccion']);
                                if(empty($personal)){
