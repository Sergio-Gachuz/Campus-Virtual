                    ...
                    <div class="card-body">
                        ...
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="tomo1-tab" data-toggle="tab" href="#tomo1" role="tab" aria-controls="tomo1" aria-selected="true" style="text-decoration: none; color: black;">Guía de Referencia I</a>
                                <a class="nav-item nav-link" id="tomo2-tab" data-toggle="tab" href="#tomo2" role="tab" aria-controls="tomo2" aria-selected="false" style="text-decoration: none; color: black;">Guía de Referencia II</a>
                                <a class="nav-item nav-link" id="tomo3-tab" data-toggle="tab" href="#tomo3" role="tab" aria-controls="tomo3" aria-selected="false" style="text-decoration: none; color: black;">Guía de Referencia III</a>
                            </div>
                        </nav>
                        <br>
